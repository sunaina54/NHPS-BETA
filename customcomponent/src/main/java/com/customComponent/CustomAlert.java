...
//		        	  ((Activity)mContext).finish();
    ...
    public static void alertWithYes(final Context mContext, String msg, final Intent nextScreen) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                mContext);
...
//		text.setFocusable(true);
    ...
    public static void alertWithYesWithTimer(final Context mContext, String msg, final Intent nextScreen) {
